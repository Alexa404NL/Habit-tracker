...
,p_group_id=>wwv_flow_imp.id(38721236637856472997)
,p_javascript_code_onload=>'apex.pwa.initPushSubscriptionPage();'
,p_step_template=>wwv_flow_imp.id(38716321099501360265)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(38721238297359472999)
...
,p_plug_template=>wwv_flow_imp.id(38716351749565360280)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(38721238687911472999)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(38721237904999472998)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(38721239110604473000)
,p_name=>'P20010_ENABLE_PUSH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(38721238687911472999)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(38721239487135473000)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(38721239934553473001)
,p_event_id=>wwv_flow_imp.id(38721239487135473000)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(38721240421149473001)
,p_event_id=>wwv_flow_imp.id(38721239487135473000)
