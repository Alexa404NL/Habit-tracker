...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(38721241887294473003)
,p_plug_name=>'&APP_USER.'
,p_region_template_options=>'#DEFAULT#:t-HeroRegion--hideIcon'
,p_plug_template=>wwv_flow_imp.id(38716390589486360296)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(38721242317007473003)
,p_plug_name=>'&APP_USER.'
,p_region_template_options=>'#DEFAULT#:t-CardsRegion--styleB'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(38716364066751360286)
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(38721242821257473003)
,p_region_id=>wwv_flow_imp.id(38721242317007473003)
,p_layout_type=>'ROW'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(38721243438785473004)
...
,p_list_id=>wwv_flow_imp.id(38721240817543473001)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(38717880673065360338)
);
