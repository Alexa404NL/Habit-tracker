...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(38716331612506360271)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716331938626360271)
,p_page_template_id=>wwv_flow_imp.id(38716331612506360271)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716332209234360271)
,p_page_template_id=>wwv_flow_imp.id(38716331612506360271)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716332520564360272)
,p_page_template_id=>wwv_flow_imp.id(38716331612506360271)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716332886991360272)
,p_page_template_id=>wwv_flow_imp.id(38716331612506360271)
,p_name=>'Body Footer'
