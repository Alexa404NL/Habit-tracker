...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(38799708376420791025)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38799708703343791026)
,p_page_template_id=>wwv_flow_imp.id(38799708376420791025)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38799709211151791026)
,p_page_template_id=>wwv_flow_imp.id(38799708376420791025)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38799709735750791027)
,p_page_template_id=>wwv_flow_imp.id(38799708376420791025)
