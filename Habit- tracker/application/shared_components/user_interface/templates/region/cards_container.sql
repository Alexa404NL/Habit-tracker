...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38716364066751360286)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716364325493360286)
,p_plug_template_id=>wwv_flow_imp.id(38716364066751360286)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716364692852360286)
,p_plug_template_id=>wwv_flow_imp.id(38716364066751360286)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716364969528360286)
,p_plug_template_id=>wwv_flow_imp.id(38716364066751360286)
,p_name=>'Sub Regions'
