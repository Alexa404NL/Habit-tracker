...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38716385941491360294)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716386269618360294)
,p_plug_template_id=>wwv_flow_imp.id(38716385941491360294)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716386575199360294)
,p_plug_template_id=>wwv_flow_imp.id(38716385941491360294)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716386828872360294)
,p_plug_template_id=>wwv_flow_imp.id(38716385941491360294)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716387180640360294)
,p_plug_template_id=>wwv_flow_imp.id(38716385941491360294)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716387476277360295)
,p_plug_template_id=>wwv_flow_imp.id(38716385941491360294)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716387771359360295)
,p_plug_template_id=>wwv_flow_imp.id(38716385941491360294)
,p_name=>'Sub Regions'
