...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38716394051423360297)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716394389550360297)
,p_plug_template_id=>wwv_flow_imp.id(38716394051423360297)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716394691766360298)
,p_plug_template_id=>wwv_flow_imp.id(38716394051423360297)
,p_name=>'Sub Regions'
