...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38717821314149360309)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717821633678360309)
,p_plug_template_id=>wwv_flow_imp.id(38717821314149360309)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717821958604360310)
,p_plug_template_id=>wwv_flow_imp.id(38717821314149360309)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717822246346360310)
,p_plug_template_id=>wwv_flow_imp.id(38717821314149360309)
,p_name=>'Sub Regions'
