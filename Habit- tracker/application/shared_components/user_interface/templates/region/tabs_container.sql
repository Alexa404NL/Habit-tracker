...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38717833865020360315)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717834191444360315)
,p_plug_template_id=>wwv_flow_imp.id(38717833865020360315)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717834499689360315)
,p_plug_template_id=>wwv_flow_imp.id(38717833865020360315)
,p_name=>'Tabs'
