...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38716390589486360296)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716390858798360296)
,p_plug_template_id=>wwv_flow_imp.id(38716390589486360296)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716391119090360296)
,p_plug_template_id=>wwv_flow_imp.id(38716390589486360296)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716391414475360296)
,p_plug_template_id=>wwv_flow_imp.id(38716390589486360296)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716391769184360296)
,p_plug_template_id=>wwv_flow_imp.id(38716390589486360296)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716392068916360296)
,p_plug_template_id=>wwv_flow_imp.id(38716390589486360296)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
