...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38716351749565360280)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716352023839360280)
,p_plug_template_id=>wwv_flow_imp.id(38716351749565360280)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716352368534360281)
,p_plug_template_id=>wwv_flow_imp.id(38716351749565360280)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716352627805360281)
,p_plug_template_id=>wwv_flow_imp.id(38716351749565360280)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716352942402360281)
,p_plug_template_id=>wwv_flow_imp.id(38716351749565360280)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716353211214360281)
,p_plug_template_id=>wwv_flow_imp.id(38716351749565360280)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716353512423360281)
,p_plug_template_id=>wwv_flow_imp.id(38716351749565360280)
,p_name=>'Sub Regions'
