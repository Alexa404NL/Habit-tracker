...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38717808839159360304)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717809173278360304)
,p_plug_template_id=>wwv_flow_imp.id(38717808839159360304)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717809405256360304)
,p_plug_template_id=>wwv_flow_imp.id(38717808839159360304)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717809739486360304)
,p_plug_template_id=>wwv_flow_imp.id(38717808839159360304)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717810087361360304)
,p_plug_template_id=>wwv_flow_imp.id(38717808839159360304)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717810310364360304)
,p_plug_template_id=>wwv_flow_imp.id(38717808839159360304)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717810609131360304)
,p_plug_template_id=>wwv_flow_imp.id(38717808839159360304)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717810945021360304)
,p_plug_template_id=>wwv_flow_imp.id(38717808839159360304)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717811263442360305)
,p_plug_template_id=>wwv_flow_imp.id(38717808839159360304)
,p_name=>'Sub Regions'
