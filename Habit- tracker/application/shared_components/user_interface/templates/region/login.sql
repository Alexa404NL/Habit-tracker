...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38717818821879360308)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717819119068360308)
,p_plug_template_id=>wwv_flow_imp.id(38717818821879360308)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717819426044360308)
,p_plug_template_id=>wwv_flow_imp.id(38717818821879360308)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717819787419360308)
,p_plug_template_id=>wwv_flow_imp.id(38717818821879360308)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717820034444360309)
,p_plug_template_id=>wwv_flow_imp.id(38717818821879360308)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717820356135360309)
,p_plug_template_id=>wwv_flow_imp.id(38717818821879360308)
,p_name=>'Sub Regions'
