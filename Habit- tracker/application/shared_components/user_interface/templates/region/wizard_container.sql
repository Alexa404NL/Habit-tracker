...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38717841580025360318)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717841883948360318)
,p_plug_template_id=>wwv_flow_imp.id(38717841580025360318)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717842145159360319)
,p_plug_template_id=>wwv_flow_imp.id(38717841580025360318)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717842400215360319)
,p_plug_template_id=>wwv_flow_imp.id(38717841580025360318)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717842765576360319)
,p_plug_template_id=>wwv_flow_imp.id(38717841580025360318)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717843025005360319)
,p_plug_template_id=>wwv_flow_imp.id(38717841580025360318)
