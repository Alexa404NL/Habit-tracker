...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38717804035450360302)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717804399262360302)
,p_plug_template_id=>wwv_flow_imp.id(38717804035450360302)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717804734807360302)
,p_plug_template_id=>wwv_flow_imp.id(38717804035450360302)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717805070847360302)
,p_plug_template_id=>wwv_flow_imp.id(38717804035450360302)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717805441463360302)
,p_plug_template_id=>wwv_flow_imp.id(38717804035450360302)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717805702530360302)
,p_plug_template_id=>wwv_flow_imp.id(38717804035450360302)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717806041300360302)
,p_plug_template_id=>wwv_flow_imp.id(38717804035450360302)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717806352418360303)
,p_plug_template_id=>wwv_flow_imp.id(38717804035450360302)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717806679642360303)
,p_plug_template_id=>wwv_flow_imp.id(38717804035450360302)
,p_name=>'Sub Regions'
