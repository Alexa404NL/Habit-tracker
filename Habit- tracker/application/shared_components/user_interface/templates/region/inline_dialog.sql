...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38716399416422360300)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716399706842360300)
,p_plug_template_id=>wwv_flow_imp.id(38716399416422360300)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716400013924360300)
,p_plug_template_id=>wwv_flow_imp.id(38716399416422360300)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717800396509360300)
,p_plug_template_id=>wwv_flow_imp.id(38716399416422360300)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717800616841360300)
,p_plug_template_id=>wwv_flow_imp.id(38716399416422360300)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717800960268360300)
,p_plug_template_id=>wwv_flow_imp.id(38716399416422360300)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717801203520360300)
,p_plug_template_id=>wwv_flow_imp.id(38716399416422360300)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717801541066360300)
,p_plug_template_id=>wwv_flow_imp.id(38716399416422360300)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717801859749360301)
,p_plug_template_id=>wwv_flow_imp.id(38716399416422360300)
,p_name=>'Sub Regions'
