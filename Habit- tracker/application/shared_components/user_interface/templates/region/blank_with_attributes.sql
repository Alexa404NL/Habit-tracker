...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38716356955954360283)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716357299125360283)
,p_plug_template_id=>wwv_flow_imp.id(38716356955954360283)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716357556377360283)
,p_plug_template_id=>wwv_flow_imp.id(38716356955954360283)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716357852662360283)
,p_plug_template_id=>wwv_flow_imp.id(38716356955954360283)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716358154832360283)
,p_plug_template_id=>wwv_flow_imp.id(38716356955954360283)
,p_name=>'Sub Regions'
