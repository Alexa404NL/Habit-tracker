...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38717814235811360306)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717814527280360306)
,p_plug_template_id=>wwv_flow_imp.id(38717814235811360306)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717814813104360306)
,p_plug_template_id=>wwv_flow_imp.id(38717814235811360306)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717815103409360306)
,p_plug_template_id=>wwv_flow_imp.id(38717814235811360306)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717815432008360307)
,p_plug_template_id=>wwv_flow_imp.id(38717814235811360306)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717815776994360307)
,p_plug_template_id=>wwv_flow_imp.id(38717814235811360306)
,p_name=>'Sub Regions'
