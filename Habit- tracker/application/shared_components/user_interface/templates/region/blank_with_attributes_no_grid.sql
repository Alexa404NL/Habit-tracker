...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38716358343329360283)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716358615220360283)
,p_plug_template_id=>wwv_flow_imp.id(38716358343329360283)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716358969779360284)
,p_plug_template_id=>wwv_flow_imp.id(38716358343329360283)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716359206412360284)
,p_plug_template_id=>wwv_flow_imp.id(38716358343329360283)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38716359585164360284)
,p_plug_template_id=>wwv_flow_imp.id(38716358343329360283)
,p_name=>'Sub Regions'
