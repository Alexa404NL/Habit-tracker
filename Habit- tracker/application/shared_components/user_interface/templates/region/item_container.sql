...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38717816311097360307)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717816653199360307)
,p_plug_template_id=>wwv_flow_imp.id(38717816311097360307)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717816951503360307)
,p_plug_template_id=>wwv_flow_imp.id(38717816311097360307)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38717817202519360307)
,p_plug_template_id=>wwv_flow_imp.id(38717816311097360307)
,p_name=>'Button Start'
